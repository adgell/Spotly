        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <div className="flex gap-12 text-sm">
              ...
              <div>
                <h4 className="font-medium mb-3 text-white/50">Legal</h4>
                <ul className="space-y-2 text-white/30">
                  <li><Link href="#" className="hover:text-white/60 transition-colors">Privacy</Link></li>
                  <li><Link href="#" className="hover:text-white/60 transition-colors">Terms</Link></li>
                </ul>
              </div>
            </div>
          </div>
